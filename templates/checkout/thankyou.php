...
if ( $payment ) : ?>
	...
	<?php if ( $payment->has_status( 'failed' ) ) : ?>
		...
		<p class="opalmembership-notice opalmembership-notice-error"><?php esc_html_e( 'Unfortunately your payment cannot be processed as the originating bank/merchant has declined your transaction.', 'opalmembership' ); ?></p>
	...
	<?php else : ?>
		...
		<p class="opalmembership-notice opalmembership-notice-success"><?php echo apply_filters( 'opalmembership_thankyou_payment_received_text', esc_html__( 'Thank you. Your payment has been received.', 'opalmembership' ), $payment ); ?></p>
...
<?php else : ?>
	...
	<p class="opalmembership-notice opalmembership-notice-success"><?php echo apply_filters( 'opalmembership_thankyou_payment_received_text', esc_html__( 'Thank you. Your payment has been received.', 'opalmembership' ), null ); ?></p>
