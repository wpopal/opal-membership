...
class Opalmembership_Metabox_Order_Notes {
	...
	public static function output( $post ) {
		...
		?>
		<div class="add_note">
			<h4><?php esc_html_e( 'Add note', 'opalmembership' ); ?> <img class="help_tip" data-tip='<?php esc_attr_e( 'Add a note for your reference, or add a customer note (the user will be notified).', 'opalmembership' ); ?>' src="<?php echo WC()->plugin_url(); ?>/assets/images/help.png" height="16" width="16" /></h4>
			<p>
