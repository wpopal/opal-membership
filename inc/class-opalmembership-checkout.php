	...
	public function checkout_form(){
		...
		if( ! empty( $purchase_info ) && isset( $purchase_info['cart'] ) ){
			if( $purchase_info['cart']['package_id'] ){
			  	return Opalmembership_Template_Loader::get_template_part( 'checkout/checkout-form', array( 'checkout' => $this ) );
			}
		} else {
			return Opalmembership_Template_Loader::get_template_part( 'no-found', array( 'checkout' => $this, 'message' => esc_html__( 'You have no package', 'opalmebership' ) ) );
		}
